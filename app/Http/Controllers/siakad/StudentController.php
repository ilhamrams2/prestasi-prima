...
public function index()
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('siakad.students.index')->with('success', 'Siswa berhasil ditambahkan!');
        } catch (\Exception $e) {
    ...
    public function edit(string $id)
    {
        ...
        return view('siakad.students.edit', compact('student', 'classes'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->route('siakad.students.index')->with('success', 'Data siswa berhasil diperbarui!');
        } catch (\Exception $e) {
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('siakad.students.index')->with('success', 'Siswa berhasil dihapus!');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Terjadi kesalahan: ' . $e->getMessage());
        }
    }
