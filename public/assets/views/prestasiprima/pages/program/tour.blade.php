{{-- ========== VIRTUAL TOUR (4 Jurusan, Route & Gambar Sama) ========== --}}
@php
  $virtualTours = [
...
<section id="virtual-tour" class="py-24 bg-white">
  <div class="max-w-7xl mx-auto px-6 md:px-10 text-center">
    ...
    {{-- Judul --}}
    <h3 class="text-2xl font-bold text-orange-600 mb-10" data-aos="fade-up" data-aos-duration="800">
      {{ $title }}
    </h3>

    {{-- Preview Card --}}
    <div class="flex justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="350">
      <div 
        class="relative w-full md:w-4/5 lg:w-2/3 rounded-2xl overflow-hidden bg-white/20 backdrop-blur-md border border-orange-100 shadow-lg transition-transform hover:scale-105 hover:shadow-2xl cursor-pointer"
