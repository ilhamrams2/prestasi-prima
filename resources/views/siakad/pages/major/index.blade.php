    ...
    <div x-show="isFormOpen"
        ...
        <div class="bg-white w-full max-w-xl rounded-2xl shadow-lg p-8 relative"
            ...
            <h2 class="text-2xl font-bold mb-6 text-gray-800 flex items-center gap-2">
                ...
                <span x-text="formMode === 'tambah' ? 'Tambah Jurusan Baru' : 'Edit Jurusan'"></span>
            </h2>

            {{-- Form --}}
            <form :action="formMode === 'tambah'
                ? '{{ route('majors.store') }}'
                : '{{ url('majors') }}/' + formData.id"
                method="POST">
                @csrf
                ...
                {{-- Nama --}}
                <div class="mb-3">
                    <label for="name" class="block text-sm font-medium">Nama Jurusan</label>
                ...
                {{-- Kode --}}
                <div class="mb-3">
                    <label for="major_code" class="block text-sm font-medium">Kode</label>
                    <input type="text" name="major_code" id="major_code"
                        class="mt-1 w-full rounded-lg border-gray-300"
                        placeholder="Contoh: TI01"
                        x-model="formData.major_code">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="mt-1 w-full rounded-lg border-gray-300"
                        placeholder="Tuliskan deskripsi jurusan"
                ...
                <div class="flex justify-end mt-6 gap-3">
                    ...
                    <button type="submit"
                        ...
                        x-text="formMode === 'tambah' ? 'Simpan' : 'Update'"></button>
                </div>
            </form>
        </div>
    </div>
...
function majorsHandler() {
    return {
        ...
        openForm(mode, data = null) {
            this.formMode = mode;
            this.formData = mode === 'edit' && data ? { ...data } : {
                id: '',
                name: '',
                major_code: '',
                description: '',
