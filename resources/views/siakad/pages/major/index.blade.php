   ...
   @section('content')
       <div class="p-6 space-y-6">
           ...
           <div class="bg-white rounded-lg shadow overflow-hidden">
               ...
               <div id="emptyState" class="hidden p-8 text-center text-gray-400">
                   ...
                   <div class="text-sm">Klik tombol <span class="font-medium">Tambah Jurusan</span> untuk menambahkan data
                       baru.</div>
               </div>
           </div>
       ...
       <div id="modalView" class="fixed inset-0 bg-black/50 hidden z-40 flex items-center justify-center">
           <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 relative">
               ...
               <p class="text-gray-600 mb-4">Jumlah Kelas: <span id="viewKelas"></span> · Jumlah Siswa: <span
                       id="viewSiswa"></span></p>
       ...
       <script>
           ...
           modal.addEventListener('click', e => {
               if (e.target === modal) closeModal('form');
           });
           ...
           function viewJurusan(id) {
               ...
               viewStatus.className =
                   `px-2 py-1 rounded text-sm ${jurusan.status === 'aktif' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`;
