                ...
                <tbody>
                    ...
                    <tr class="border-t hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3"><span
                                class="bg-green-100 text-green-700 px-2 py-1 rounded text-sm">Aktif</span></td>
                        <td class="px-4 py-3 flex space-x-3">
                            <button title="Lihat" class="text-blue-500 hover:text-blue-700"><i
                                    class="ri-eye-line"></i></button>
                            <button title="Edit" class="text-orange-500 hover:text-orange-700"><i
                                    class="ri-edit-line"></i></button>
                            <button title="Hapus" onclick="confirmDelete(this)" class="text-red-500 hover:text-red-700"><i
