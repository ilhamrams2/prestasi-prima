...
<div x-data="{ open: false }" class="flex">
  ...
  <header class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b flex items-center justify-between px-4 py-3">
    ...
    <div class="p-4 border-b">
      <div class="flex items-center justify-between gap-3">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div class="min-w-0">
            <div class="text-sm font-semibold text-gray-800 truncate">Ardy Albanna</div>
            <div class="text-xs text-gray-500 truncate">auladany.pplg@smkpra</div>
          </div>
        </div>
        <span class="text-xs px-2 py-0.5 rounded-full bg-green-100 text-green-700 font-medium">Siswa</span>
      </div>
    </div>
