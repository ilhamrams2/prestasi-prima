<aside id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto p-3 text-sm">
        ...
        <a href="{{ route('siakad.dashboard') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
        ...
        <a href="{{ route('majors.index') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
            text-gray-700 hover:bg-orange-50 hover:text-orange-600">
            <i class="ri-book-2-line text-lg"></i>
            <span>Jurusan</span>
        </a>
        <a href="{{ route('classes.index') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
            text-gray-700 hover:bg-orange-50 hover:text-orange-600">
            <i class="ri-stack-line text-lg"></i>
            <span>Kelas</span>
        </a>
        <a href="{{ route('students.index') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
            text-gray-700 hover:bg-orange-50 hover:text-orange-600">
            <i class="ri-user-3-line text-lg"></i>
            <span>Siswa</span>
        </a>
        <a href="{{ route('teacher.index') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
            text-gray-700 hover:bg-orange-50 hover:text-orange-600">
    <i class="ri-presentation-line text-lg"></i>
            <span>Guru</span>
        </a>
        <a href="{{ route('absence.index') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
            text-gray-700 hover:bg-orange-50 hover:text-orange-600">
            <i class="ri-calendar-check-line text-lg"></i>
            <span>Absensi</span>
        </a>
        <a href="{{ route('scores.index') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
            text-gray-700 hover:bg-orange-50 hover:text-orange-600">
   ...
   class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
    ...
    <span>Pengumuman</span>
        ...
        <div class="border-t mt-4 pt-3">
            <a href="{{ route('siakad.logout') ?? '#' }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
