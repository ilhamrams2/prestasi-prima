...
>>>>>>> 278baf2 (update sidebar, dashboard, dan index siakad)
  <!-- ================= LOGO ================= -->
...
=======
<nav class="flex-1 overflow-y-auto p-3 text-sm">
>>>>>>> c1b5549 (update untuk siakad profile)
  ...
  <!-- PROFIL -->
  <a href="{{ route('siakad.profile') }}" 
     class="flex items-center space-x-3 px-3 py-2 rounded-lg transition
     {{ request()->routeIs('siakad.profile') ? 'bg-orange-100 text-orange-600' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}">
      <i class="ri-user-3-line text-lg"></i>
