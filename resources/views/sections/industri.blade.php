...
<section id="industri" class="relative py-24 bg-white overflow-hidden">
  ...
  <img src="{{ asset('assets/images/section/industri/network1.svg') }}" 
       ...
       class="absolute top-6 right-6 w-[32rem] sm:w-[36rem] md:w-[40rem] opacity-0 translate-y-8 transition-all duration-1000 ease-out scroll-fade pointer-events-none select-none">

  <img src="{{ asset('assets/images/section/industri/network2.svg') }}" 
       alt="Dekorasi Network 2"
       class="absolute bottom-0 left-0 w-44 sm:w-60 md:w-72 opacity-0 translate-y-8 transition-all duration-1000 ease-out scroll-fade pointer-events-none select-none">
...
.animate-scroll-modern {
  display: flex;
  width: max-content;
  animation: scroll-modern 25s linear infinite;
}
