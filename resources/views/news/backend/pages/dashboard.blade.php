...
<div class="flex justify-center items-center min-h-screen mt-12 px-4"
    ...
    <div class="flex flex-col md:flex-row overflow-hidden gap-4 w-full max-w-[1280px]">
        ...
        <!-- Sidebar -->
        <aside class="bg-orange-500 text-white flex flex-col justify-between p-6 rounded-3xl shadow-lg
              w-full md:w-[222px] h-auto md:h-[478px]">
            <div>
                <h1 class="text-center font-bold mb-8 text-white text-xl md:text-[25px]">
                    News Management
                </h1>
                ...
                <nav class="space-y-4">
                    <!-- Home -->
                    <a href="#"
                       class="flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-500 ease-in-out
                              {{ request()->is('/') ? 'bg-white text-orange-600 scale-[1.05] shadow-md' : 'bg-transparent' }}">
                        <img src="{{ asset('assets/images/news/home.svg') }}" alt="Home"
                             class="w-[28px] h-[29px] transition-transform duration-500">
                        <span>Home</span>
                    </a>
                    ...
                    <a href="{{ route('news.index') }}"
                       class="flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-500 ease-in-out
                              {{ request()->routeIs('news.index') ? 'bg-white text-orange-600 scale-[1.05] shadow-md' : 'bg-transparent' }}">
                        <img src="{{ asset('assets/images/news/daftar.svg') }}" alt="Daftar Berita"
                             class="w-[28px] h-[29px] transition-transform duration-500">
                    ...
                    <a href="#"
                       class="flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-500 ease-in-out
                              {{ request()->is('setting') ? 'bg-white text-orange-600 scale-[1.05] shadow-md' : 'bg-transparent' }}">
                        <img src="{{ asset('assets/images/news/setting.svg') }}" alt="Setting"
                             class="w-[28px] h-[29px] transition-transform duration-500">
                        <span>Setting</span>
                    </a>
                </nav>
