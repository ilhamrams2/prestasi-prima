                        ...
                        @foreach ($students->skip(3) as $student)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-4 w-32">
                                    ...
                                    @else
                                        <button disabled class="bg-gray-300 text-white rounded-full py-1 px-4 cursor-not-allowed">view profile</button>
                                    @endif
                                </td>
                            </tr>
                        @endforeach

                        {{-- Jika tidak ada data selain top 3 --}}
                        @if($students->count() <= 3)
                            <tr class="border-t">
                                <td class="px-4 py-4 w-12">-</td>
                                <td class="px-4 py-4 w-44">Tidak ada data lebih lanjut</td>
                                <td class="px-4 py-4 w-16">-</td>
                                <td class="px-4 py-4 w-16">-</td>
                                <td class="px-4 py-4 w-24">-</td>
                                <td class="px-4 py-4 w-32"></td>
                            </tr>
                        @endif
                    </tbody>
                </table>
