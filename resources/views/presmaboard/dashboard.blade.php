...
<div class="w-full px-6 lg:px-10 py-6 space-y-10">
    ...
    <div class="bg-gradient-to-r from-orange-600 to-yellow-400 text-white rounded-2xl shadow-lg p-6 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        @php
            $stats = [
                ['icon' => 'ri-user-3-line', 'label' => 'Total Siswa', 'value' => '480', 'color' => 'blue'],
                ['icon' => 'ri-user-star-line', 'label' => 'Total Guru', 'value' => '32', 'color' => 'green'],
                ['icon' => 'ri-trophy-line', 'label' => 'Total Prestasi', 'value' => '128', 'color' => 'yellow'],
                ['icon' => 'ri-folder-open-line', 'label' => 'Proyek Aktif', 'value' => '56', 'color' => 'orange'],
            ];
        @endphp
    ...
    <div>
        ...
        <div class="bg-white rounded-xl shadow-md divide-y">
            @foreach ([
                ['Gibran menambahkan proyek baru "Web Edukasi Sekolah"', '5 menit yang lalu'],
                ['Ardy memperbarui data prestasi siswa kelas X PPLG', '10 menit yang lalu'],
                ['Admin menghapus pengumuman lama', '1 jam yang lalu'],
            ] as [$text, $time])
    ...
    <div class="bg-gradient-to-r from-orange-500 to-yellow-400 rounded-xl text-white p-6 shadow-md">
        ...
        <form class="flex flex-col sm:flex-row gap-3">
            <input type="text" placeholder="Tulis pengumuman..." class="flex-1 px-4 py-2 rounded-lg text-gray-800 focus:ring-2 focus:ring-orange-400 outline-none">
            <button class="bg-white text-orange-600 font-semibold px-5 py-2 rounded-lg hover:bg-gray-100 transition">Kirim</button>
        </form>
    </div>
