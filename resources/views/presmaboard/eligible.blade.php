...
<div class="bg-gray-50 p-4 md:p-6 min-h-screen flex flex-col items-center mt-28">
    <div class="w-full max-w-7xl space-y-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 w-full">
                ...
                @foreach ($info as $item)
                    <div
                        ...
                        <div class="bg-gradient-to-br from-orange-400 to-orange-500 w-11 h-11 flex items-center justify-center rounded-xl mb-2 shadow-sm">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-4">
            <!-- Achievements -->
            <div class="bg-white p-6 rounded-2xl shadow-sm animate-fadeInUp xl:col-span-1 hover:shadow-md transition duration-300">
            ...
            <!-- Projects -->
            <div class="bg-white p-6 rounded-2xl shadow-sm animate-fadeInUp xl:col-span-2 hover:shadow-md transition duration-300">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-h-[460px] overflow-y-auto">
                    ...
                    @empty
                        <p class="text-gray-400 italic text-center col-span-full py-10">Belum ada project yang diunggah.</p>
                    @endforelse
                </div>
            </div>
        </div>
