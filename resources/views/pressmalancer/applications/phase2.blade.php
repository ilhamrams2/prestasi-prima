...
<div x-data="{ isCollapsed: false, showMobileMenu: false }" class="relative">
    ...
    <div 
        ...
        class="fixed inset-0 bg-white bg-opacity-50 z-40 lg:hidden"
        style="display: none;"
    ></div>
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-2">
                ...
                <a 
                    ...
                    class="flex items-center gap-3 py-3 rounded-lg transition-all duration-200
                           {{ request()->routeIs('admin.jobs.index') ? 'bg-orange-50 text-orange-600' : 'text-gray-700 hover:bg-gray-100' }}"
                >
                ...
                <a 
                    ...
                    :class="isCollapsed ? 'justify-center px-2' : 'px-4'"
                    class="flex items-center gap-3 py-3 rounded-lg transition-all duration-200
                           {{ request()->routeIs('admin.jobs.*') ? 'bg-orange-50 text-orange-600' : 'text-gray-700 hover:bg-gray-100' }}"
                >
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                    <span x-show="!isCollapsed" class="font-medium">Manage Jobs</span>
                </a>
                ...
                <a 
                    ...
                    :class="isCollapsed ? 'justify-center px-2' : 'px-4'"
                    class="flex items-center gap-3 py-3 rounded-lg transition-all duration-200
                           {{ request()->routeIs('admin.companies.*') ? 'bg-orange-50 text-orange-600' : 'text-gray-700 hover:bg-gray-100' }}"
                >
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                    </svg>
                ...
                <a 
                    href="#"
                    :class="isCollapsed ? 'justify-center px-2' : 'px-4'"
                    class="flex items-center gap-3 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-all duration-200"
                >
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                    ...
                    :class="isCollapsed ? 'justify-center px-2' : 'px-4'"
                    class="flex items-center gap-3 py-3 rounded-lg transition-all duration-200
                           {{ request()->routeIs('jobs.index') ? 'bg-orange-50 text-orange-600' : 'text-gray-700 hover:bg-gray-100' }}"
                >
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                >
                    ...
                    <span x-show="!isCollapsed" class="font-medium">Analytics</span>
                </a>
                ...
                >
                    ...
                    <span x-show="!isCollapsed" class="font-medium">Settings</span>
                </a>
            </nav>
        </div>
    </aside>
