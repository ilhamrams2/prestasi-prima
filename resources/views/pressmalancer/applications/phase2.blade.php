        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6 animate-in slide-in-from-bottom duration-500 delay-100">
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Fase 2 Segera Hadir!</h3>
                    <p class="text-gray-600 mb-8">
                        Fase ini akan berisi pertanyaan dari perusahaan yang harus Anda jawab.<br>
                        Untuk saat ini, Anda dapat melanjutkan dengan kembali ke daftar lowongan.
                    </p>
                    
                    <div class="flex justify-center gap-4">
                        <a 
                            href="{{ route('jobs.index') }}"
                            class="inline-flex items-center px-6 py-3 border border-orange-500 text-orange-600 rounded-lg hover:bg-orange-50 transition-all"
                        >
                        ...
                        <a 
                            ...
                            class="inline-flex items-center px-6 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-all"
                        >
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
