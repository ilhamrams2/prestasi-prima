...
@section('title', 'Tambah Preset Hero Video')
...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-extrabold text-slate-800 tracking-tight">Tambah Preset Hero Video</h1>
                <p class="text-sm text-slate-500 font-medium">Konfigurasikan video YouTube baru untuk background landing page.</p>
            </div>
        </div>
    </div>

    {{-- ================= FORM ================= --}}
    <form action="{{ route('prestasiprima.admin.hero.store') }}" method="POST" class="space-y-8">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-7 bg-white rounded-3xl sm:rounded-[2.5rem] shadow-sm border border-slate-100 p-6 sm:p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" value="{{ old('title', 'Video Profil Utama') }}" required
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="video_url" id="video_url_input" value="{{ old('video_url', 'https://www.youtube.com/watch?v=EYzn0caf0_k') }}" required
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="headline_top" value="{{ old('headline_top', 'PRESTASI') }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="headline_bottom" value="{{ old('headline_bottom', 'PRIMA') }}"
                               placeholder="PRIMA"
                               class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-800 focus:bg-white focus:border-orange-500 outline-none">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="tagline" value="{{ old('tagline', '"If better is possible, good is not enough"') }}"
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-medium text-slate-800 focus:bg-white focus:border-orange-500 outline-none">{{ old('description', 'Mencetak generasi unggul yang tidak hanya kompeten secara teknis, namun juga memiliki integritas karakter untuk memimpin masa depan industri global.') }}</textarea>
                </div>
                ...
                <div class="pt-4 border-t border-slate-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="text" name="hud_tag" value="{{ old('hud_tag', 'Institutional Vision / 2025') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="hud_status" value="{{ old('hud_status', 'Status: Active') }}"
                                   class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-800 outline-none">
                        </div>
                        <div>
                            <label class="block text-[11px] font-bold text-slate-600 mb-1">HUD Mission</label>
                            <input type="text" name="hud_mission" value="{{ old('hud_mission', 'Mission / 01') }}"
                                   class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium text-slate-800 outline-none">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl sm:rounded-[2.5rem] border border-slate-100 shadow-sm space-y-4">
                    ...
                    <div class="p-3 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-3">
                        ...
                        <div class="text-xs">
                            ...
                            <span id="detected_yt_id" class="font-mono font-bold text-slate-800">EYzn0caf0_k</span>
                        </div>
                    </div>
                </div>
