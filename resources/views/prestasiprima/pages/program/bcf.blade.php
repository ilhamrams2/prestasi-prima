...
@section('title', 'BCF — Broadcasting & Film')
...
<div class="bg-white overflow-hidden relative">
  ...
  <section class="pt-48 pb-20 px-6 bg-white relative grid-bg">
    ...
    <div class="text-ghost top-24 -left-20">BROADCAST</div>
    ...
    <div class="max-w-7xl mx-auto relative z-10">
      <div class="flex flex-col items-start gap-6 mb-12" data-aos="fade-up">
        <div class="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-orange-50 border border-orange-100">
          ...
          <span class="font-outfit text-[10px] font-bold uppercase tracking-[0.2em] text-[#FF6B00]">BCF SPECIALIZATION</span>
        </div>
      </div>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div data-aos="fade-right" data-aos-delay="100">
          <h1 class="font-outfit text-mask-hero">
            Broadcasting <br>
            <span class="highlight-orange">& Film.</span>
          </h1>
          <p class="mt-8 font-jakarta text-gray-500 text-lg md:text-xl leading-relaxed max-w-xl">
            Menciptakan konten visual yang menginspirasi. Kami membentuk kreator profesional yang mahir dalam produksi audio-visual, sinematografi, dan penyiaran modern.
          </p>
          <div class="mt-10 flex flex-wrap gap-4">
            ...
            <div class="flex items-center gap-3 px-6 py-4 rounded-2xl border border-gray-100 bg-gray-50/50">
               <iconify-icon icon="lucide:video" class="text-2xl text-orange-600"></iconify-icon>
               <span class="font-jakarta font-bold text-[#0e162e] text-sm tracking-tight text-nowrap">Professional Production</span>
            </div>
          </div>
        </div>
        ...
        <div class="relative" data-aos="fade-left" data-aos-delay="200">
            <div class="relative rounded-[3rem] overflow-hidden shadow-2xl">
                <img src="{{ asset('assets/images/program/bcf.png') }}" alt="BCF Hero" class="w-full h-full object-cover">
            ...
            <div class="absolute -bottom-6 -right-6 bg-white p-6 rounded-[2rem] shadow-2xl border border-gray-50 flex items-center gap-4 animate-bounce-slow">
                <div class="w-12 h-12 bg-orange-100 rounded-2xl flex items-center justify-center">
                    <iconify-icon icon="lucide:camera" class="text-2xl text-orange-600"></iconify-icon>
                </div>
                <div>
                    <div class="font-outfit font-black text-[#0e162e] text-lg">4K Quality</div>
                    <div class="font-jakarta text-xs text-gray-400 font-bold">Cinema Standard</div>
                </div>
            </div>
        </div>
      </div>
  ...
  <section id="about" class="py-32 px-6 bg-[#fcfcfd] border-y border-gray-50 relative">
    <div class="max-w-7xl mx-auto">
      <div class="grid lg:grid-cols-2 gap-20 items-center">
        <div data-aos="fade-up">
            ...
            <h2 class="font-outfit text-4xl md:text-6xl font-black text-[#0e162e] tracking-tight leading-none mb-8">
                Menceritakan Kisah <br><span class="highlight-orange">Melalui Visual.</span>
            </h2>
            <p class="font-jakarta text-gray-500 text-lg leading-relaxed mb-8">
                Program Keahlian Broadcasting & Film (BCF) berfokus pada penguasaan teknik produksi audio-visual profesional, dari pra-produksi hingga pasca-produksi, termasuk sinematografi, penyutradaraan, editing, dan teknik penyiaran modern.
            </p>
            
            <div class="space-y-4">
                @foreach(['Professional Cinematography', 'Advanced Video Editing', 'Live Broadcasting Production'] as $item)
        ...
        <div class="dev-window" data-aos="zoom-in" data-aos-delay="200">
            <div class="dev-header">
                ...
                <span class="text-xs font-mono text-gray-400 ml-4">~/prestasiprima/bcf/production.js</span>
            </div>
            <div class="p-8 font-mono text-sm leading-loose">
                <div class="text-gray-500">// Initialize the next generation of filmmakers</div>
                <div class="text-white"><span class="text-pink-500">const</span> <span class="text-blue-400">BCF</span> = {</div>
                <div class="pl-6 text-white">skills: [<span class="text-green-400">'Cinematography'</span>, <span class="text-green-400">'Editing'</span>, <span class="text-green-400">'Broadcasting'</span>],</div>
                <div class="pl-6 text-white">industry_ready: <span class="text-orange-400">true</span>,</div>
                <div class="pl-6 text-white">creativity: <span class="text-orange-400">Infinity</span>,</div>
                <div class="pl-6 text-white">createStory: () => {</div>
                <div class="pl-12 text-blue-300">return <span class="text-yellow-400">"Masterpiece"</span>;</div>
                <div class="pl-6 text-white">}</div>
                <div class="text-white">};</div>
                <div class="mt-6 text-orange-400 shadow-orange-500/20 shadow-xl inline-block bg-orange-500/10 px-4 py-2 rounded-lg">&gt; BCF.createStory()</div>
                <div class="mt-2 text-green-400">"Masterpiece"</div>
            </div>
        </div>
      </div>
      ...
      <div class="mt-32 flex flex-col md:flex-row items-center gap-12 bg-white p-12 rounded-[3.5rem] shadow-xl border border-gray-50" data-aos="fade-up">
        <img src="{{ asset('assets/images/staff/kapro4.jpg') }}" alt="Kapro BCF" class="w-48 h-64 object-cover rounded-[2.5rem] shadow-2xl">
        <div>
            ...
            <h3 class="font-outfit text-3xl font-black text-[#0e162e] mb-4">Muhamad Ichsan A.Md</h3>
            <p class="font-jakarta text-gray-500 text-lg italic leading-relaxed max-w-2xl">
                "Dunia film dan broadcasting bukan sekadar hiburan, tapi media untuk menyampaikan pesan dan inspirasi yang dapat mengubah perspektif dan membentuk karakter."
            </p>
        </div>
      </div>
    </div>
  ...
  <section class="py-32 px-6 bg-[#0e162e] relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
      @foreach([
        ['lucide:camera', 'Sinematografer', 'Menguasai teknik pengambilan gambar profesional dengan komposisi visual yang kuat.'],
        ['lucide:mic', 'Penyiar / Presenter', 'Menyampaikan informasi dengan komunikasi yang efektif dan menarik di media broadcasting.'],
        ['lucide:clapperboard', 'Sutradara', 'Memimpin proses kreatif produksi dari konsep hingga eksekusi final.'],
        ['lucide:film', 'Editor Video / Film', 'Mengolah footage menjadi karya visual yang koheren dan menarik.'],
        ['lucide:radio', 'Produser Program', 'Mengelola dan mengkoordinasikan seluruh aspek produksi program.'],
        ['lucide:tv', 'Crew Produksi TV', 'Mendukung operasional teknis dalam produksi televisi profesional.'],
      ] as [$icon, $title, $desc])
  ...
  <section class="py-24 bg-white border-b border-gray-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 text-center mb-20">
        <h3 class="font-outfit text-xl font-black text-[#0e162e] uppercase tracking-[0.3em]">Professional Equipment</h3>
    </div>
    
    <div class="flex flex-col gap-4 md:gap-8">
        {{-- Row 1: Tech Group A (1-4) --}}
            ...
            @for ($k = 0; $k < 4; $k++)
              @for ($i = 1; $i <= 4; $i++)
                <div class="flex-shrink-0 w-48 md:w-64 h-28 md:h-36 flex items-center justify-center bg-white rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-gray-100 hover:border-orange-200 transition-all hover:shadow-xl group">
                  <img src="{{ asset('assets/images/program/bcf/logo (' . $i . ').png') }}" 
                       alt="Tech {{ $i }}" 
  ...
  {{-- ========== JOURNEY, TOUR, FAQ ========== --}}
  <div class="bg-[#fcfcfd]">
    @include('prestasiprima.pages.program.journey', ['program' => 'bcf'])
  </div>
