...
<section class="relative bg-white py-16 mt-20">
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
    ...
    <!-- Foto Sambutan -->
    <div class="relative">
      <div class="bg-[#0C2340] rounded-2xl p-4 shadow-xl w-fit mx-auto">
    ...
    <!-- Isi Sambutan -->
    <div>
      <h3 class="text-sm font-bold text-[#6C6C6C] uppercase tracking-widest">
        Penjamin Mutu Yayasan Prestasi Prima
      </h3>
      <h2 class="text-2xl md:text-3xl font-extrabold text-[#0C2340] mt-2">
      ...
      <div class="mt-6">
        <a href="#"
           class="inline-block bg-[#FF5C00] hover:bg-[#FF4D00] text-white px-6 py-3 rounded-lg font-semibold shadow-md transition">
          Daftar Sekarang →
        </a>
      </div>
    </div>
