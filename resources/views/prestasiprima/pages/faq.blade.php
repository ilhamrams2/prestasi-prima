...
@section('content')
<section
  class="relative min-h-screen bg-gradient-to-b from-orange-50 via-white to-orange-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 pt-44 pb-28 overflow-hidden"
  x-data="{ open: null }"
>
  {{-- Dekorasi latar --}}
  <div class="absolute inset-0 -z-10 overflow-hidden">
    ...
    <div class="absolute bottom-0 right-10 w-[28rem] h-[28rem] bg-orange-300/40 dark:bg-orange-600/20 rounded-full blur-3xl animate-pulse-slow delay-1000"></div>
  </div>

  {{-- Header --}}
  <div class="max-w-5xl mx-auto text-center px-6 mb-6">
<h1 class="text-5xl md:text-6xl font-extrabold text-gray-800 dark:text-white mb-4 pb-6 relative inline-block">
      Pertanyaan Umum
  <span class="absolute bottom-0 left-1/2 -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-orange-500 to-orange-700 rounded-full"></span>
    </h1>
  ...
  <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 px-6">
    @php
      $faqs = [
        ['icon' => 'graduation-cap', 'question' => 'Bagaimana cara mendaftar di Sekolah Prestasi Prima?', 'answer' => 'Pendaftaran dapat dilakukan secara online melalui laman resmi sekolah, atau dengan datang langsung ke bagian administrasi sambil membawa dokumen yang dibutuhkan.'],
        ...
        ['icon' => 'phone-call', 'question' => 'Bagaimana cara menghubungi pihak sekolah?', 'answer' => 'Anda dapat menghubungi kami melalui halaman Kontak, email resmi, atau datang langsung ke sekolah pada jam operasional (Senin–Jumat, 08.00–15.00).'],
      ];
    @endphp
    ...
    <div
      ...
      :class="{ 'ring-2 ring-orange-400/60 scale-[1.02]': open === {{ $index }} }"
    >
      {{-- Pertanyaan --}}
      <div class="flex items-center gap-4 px-6 py-6">
        <div
          class="p-3 rounded-xl bg-gradient-to-br from-orange-400 via-orange-500 to-orange-600 text-white shadow-lg group-hover:scale-110 transition-transform duration-300"
        >
        ...
        <i
          ...
          :class="{ 'rotate-180 text-orange-500': open === {{ $index }} }"
        ></i>
      </div>
  ...
  <div class="mt-24 text-center">
    ...
    <a href="https://wa.me/6281234567890"
      class="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold px-10 py-4 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
